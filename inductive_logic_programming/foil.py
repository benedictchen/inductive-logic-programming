...
try:
    ...
    # Fallback to absolute imports when not imported as package
    try:
        from inductive_logic_programming import (
            LogicalTerm, LogicalAtom, LogicalClause, Example,
            InductiveLogicProgrammer
        ...
        # Define minimal compatibility classes if imports fail
        @dataclass
        class LogicalTerm:
            name: str
            args: List[Any] = None
        ...
        class LogicalAtom:
            predicate: str
            terms: List[LogicalTerm] = None
            
        @dataclass
        class LogicalClause:
            head: LogicalAtom
            body: List[LogicalAtom] = None
